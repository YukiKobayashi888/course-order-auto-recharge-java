...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of account.balance, account.autorecharge.configure, email.send) and reuse it from your own code.
